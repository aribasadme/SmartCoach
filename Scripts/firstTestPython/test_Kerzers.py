# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 12:10:07 2015
...
fig.savefig('estimatedTime_vs_effort_Kerzers_copia.pdf', dpi=fig.dpi, bbox_inches='tight')
...
ax1.set_title('Personalized Effort',fontsize=16,y=1.02)
...
ax2.set_title('Estimated time (Effort={:.1f} %)'.format(probabilities[effort_index-10]),fontsize=16, y=1.02)
...
ax3.set_ylim([0.,5.])
ax3.set_title('Speed',fontsize=16,y=1.02)
ax3.set_xlabel('Distance ['r'$m$]')
ax3.set_ylabel('Speed ['r'$m/s$]')
plt.grid(alpha=0.5)
...
pp = PdfPages('estimatedTimeRunKerzers_user_copia.pdf')
pp.savefig()
pp.close()
